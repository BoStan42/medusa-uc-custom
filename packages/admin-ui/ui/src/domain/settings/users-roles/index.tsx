    ...
    <div className="flex h-full flex-col">
      <div className="flex w-full grow flex-col">
        ...
        <BodyCard
          ...
          subtitle={t('users-roles-description', 'Manage users roles')}
          actionables={actionables}
        >
          <div className="flex grow flex-col justify-between">
            <UserRolesTable roles={roles} triggerRefetch={triggerRefetch} />
          </div>
          {showModal && <AddRoleModal onClose={handleClose} onSuccess={handleSuccess} />}
        </BodyCard>
      </div>
    </div>
  );

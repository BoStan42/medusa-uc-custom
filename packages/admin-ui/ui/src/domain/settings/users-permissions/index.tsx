    ...
    <div className="flex h-full flex-col">
      <div className="flex w-full grow flex-col">
        ...
        <BodyCard
          ...
          subtitle={t('users-permissions-description', 'Manage users permissions')}
          actionables={actionables}
        >
          <div className="flex grow flex-col justify-between">
            <UserPermissionsTable permissions={permissions} triggerRefetch={triggerRefetch} />
          </div>
          {showModal && <AddPermissionModal onClose={handleClose} onSuccess={handleSuccess} />}
        </BodyCard>
      </div>
    </div>
  );

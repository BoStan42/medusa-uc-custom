    ...
    mutate(data, {
      onSuccess: () => {
        notification(
          ...
          t('settings-successfully-updated-store', 'Successfully updated store'),
          'success',
        );
      },
      onError: error => {
      ...
      <div className="max-w-[632px]">
        ...
        >
          <div className="gap-y-xlarge mb-large flex flex-col">
            ...
            <div>
              <h2 className="inter-base-semibold mb-base">{t('settings-advanced-settings', 'Advanced settings')}</h2>
              <Input

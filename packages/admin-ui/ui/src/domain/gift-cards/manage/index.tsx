      ...
      <div className="gap-x-base grid grid-cols-12">
        <div className="gap-y-xsmall col-span-8 flex flex-col">
          {getWidgets('gift_card.details.before').map((w, i) => {
            return <WidgetContainer key={i} widget={w} injectionZone={'gift_card.details.before'} entity={giftCard} />;
          })}
          ...
          {getWidgets('gift_card.details.after').map((w, i) => {
            return <WidgetContainer key={i} widget={w} injectionZone={'gift_card.details.after'} entity={giftCard} />;
          })}

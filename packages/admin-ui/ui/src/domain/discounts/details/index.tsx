    ...
    <div className="pb-xlarge">
      {showDelete && (
        <DeletePrompt
          ...
          text={t('details-confirm-delete-discount', 'Are you sure you want to delete this discount?')}
      ...
      <div className="gap-y-xsmall flex flex-col">
        <DiscountFormProvider>
          {getWidgets('discount.details.before').map((w, index) => {
            return <WidgetContainer key={index} entity={discount} widget={w} injectionZone="discount.details.before" />;
          })}
          ...
          {getWidgets('discount.details.after').map((w, index) => {
            return <WidgetContainer key={index} entity={discount} widget={w} injectionZone="discount.details.after" />;
          })}
